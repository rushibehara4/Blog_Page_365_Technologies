        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <div className="api-list-con">
              ...
              <p className="fst-italic mb-0">https://jsonplaceholder.typicode.com/posts/id/comments</p>
              <p className="text-muted mb-0">example: To Fetch Comments of Blog with id - 2</p>
              <p className="fst-italic mb-0">https://jsonplaceholder.typicode.com/posts/2/comments</p>
            </div>
            ...
            <div className="api-bot-con">
              <p className="p-2">Use Network Console to find any more API's that are being used</p>
            </div>
          </div>
          <div className="col-md-4">
            ...
            <div className="assign-para">
              <p className="mb-1 p-2">Go through this application in detail, understand what has been done</p>
              <hr className="mt-0 mb-0" />
              <p className="mb-1 p-2">try to build, as much of this application as possible</p>
              <hr className="mt-0 mb-0" />
              <p className="mb-1 p-2">You can try to build same, less or more features</p>
              <hr className="mt-0 mb-0" />
              <p className="mb-1 p-2">you are free to use any tech/platform/language</p>
              <hr className="mt-0 mb-0" />
              <p className="mb-1 p-2">You are free to build a) webapp or b) mobile app or c)desktop app</p>
              <hr className="mt-0 mb-0" />
              <p className="mb-1 p-2">you are build SPA (react, vue etc...) or SSR (spring boot etc)</p>
              <hr className="mt-0 mb-0" />
            </div>
          </div>
        </div>
